...
class MeetingDetails(QtWidgets.QWidget):
    def __init__(self, window_title, meeting_title, meeting_description, meeting_time, meeting_date):
        ...
        self.meeting_title.setGeometry(10, 10, 380, 50)
        self.meeting_title.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.meeting_title.setObjectName('meeting_info')
        ...
        self.meeting_description.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.meeting_description.setObjectName('meeting_info')
        self.meeting_date = QtWidgets.QLabel(F'MEETING DATE: {self.meeting_date}', self)
        self.meeting_date.setGeometry(10, 130, 380, 50)
        self.meeting_date.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.meeting_date.setObjectName('meeting_info')
        self.meeting_time = QtWidgets.QLabel(F'MEETING TIME: {self.meeting_time}', self)
        self.meeting_time.setGeometry(10, 190, 380, 50)
        self.meeting_time.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.meeting_time.setObjectName('meeting_info')
        self.close_button = QtWidgets.QPushButton('CLOSE', self)
        self.close_button.setGeometry(10, 250, 380, 40)
